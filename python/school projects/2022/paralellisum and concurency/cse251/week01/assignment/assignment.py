...
def run_with_threads(tur, log, main_turtle):
    ...
    s = threading.Thread(target=draw_squares, args=(tur,))
    c = threading.Thread(target=draw_circles, args=(tur,))
    t = threading.Thread(target=draw_triangles, args=(tur,))
    r = threading.Thread(target=draw_rectangles, args=(tur,))
