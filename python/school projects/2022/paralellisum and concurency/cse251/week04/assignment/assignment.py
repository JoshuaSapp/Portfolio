...
class Factory(threading.Thread):
    ...
    def run(self,queue,semaphore,queue_stats):
...
def main():
    ...
    F = Factory()
    factory = threading.Thread(target=F.run,args=(queue,semaphore,queue_stats))

    # TODO create your one dealership
    D = Dealer()
    dealership = threading.Thread(target=D.run,args=(queue,semaphore))
