...
# Defect(s) Found: 
    # Queue.enque was adding people back at the begining of the list, effectivly adding them to the beggingig of the line. Changed it to append instead of insert.
...
print(players)    
# Defect(s) Found: 
    # taking_turns_cueue.Get next person was not adding players with 0 or less turns back into the cue for infinite turns. reworked to check for zero before subtracting.  all other results get -1 applied then checked for zero.
